  ...
  return (
    <div>
      <div className="w-full h-full px-24 py-14">
        ...
        <div className="flex rounded-2xl overflow-hidden gap-4 mb-9 min-h-100">
          <div className="w-1/2">
            <Video className={movie?.trailer}/>
          </div>
          <div className="w-1/2 grid grid-cols-2 grid-rows-2 gap-4">
            <div className="bg-cinebhdarkgray text-center">PLACEHOLDER</div>
            <div className="bg-cinebhdarkgray text-center">PLACEHOLDER</div>
            <div className="bg-cinebhdarkgray text-center">PLACEHOLDER</div>
            <div className="bg-cinebhdarkgray text-center">PLACEHOLDER</div>
          </div>
          ...
          <div className="flex flex-col w-1/2">
            ...
            <div className="flex gap-4">
              {movie?.genres.map((movieGenre) => (
                <div key={movieGenre.genre.id} className="px-2 py-1.5 rounded-lg bg-cinebhpale text-cinebhdark flex items-center justify-center mb-4">
